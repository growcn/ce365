...
public class Download implements Serializable {
	...
	public Download(int downloadId, String url, String localPath, String DLname) {
		...
		try {
			...
			if (httpCode >= 200 && httpCode <= 300) {
				...
				while (-1 != (len = in.read(bytes))) {
					...
					// Log.log((int)(downloadedLength/(float)remoteFileLength *
					// 100));
...
//
// Download d = new Download(1,
// "http://baidu.com/test.zip","/sdcard/download/");
//
